<template>
  <section class="bg-base-100 py-20 px-6 lg:px-20 xl:px-32 relative overflow-hidden" id="catalog-nutrition">
    ...
    <div class="mb-16 border-l-8 border-primary pl-6 md:pl-10">
      ...
      <h2 class="text-4xl md:text-7xl lg:text-8xl font-anton uppercase leading-[0.9] text-base-content mb-6">
      ...
      >
        ...
        <div class="w-full lg:w-1/2">
          ...
          <div class="flex items-baseline gap-2 mb-6">
            <span class="font-anton text-4xl md:text-6xl text-primary">{{ item.price }}</span>
          ...
          <a :href="`https://wa.me/6285939533337?text=Hello%20Coach%20Yohan!%20I%20would%20like%20to%20order%20${encodeURIComponent(item.title)}%20for%20${encodeURIComponent(item.price + ' ' + item.priceSuffix)}.%20How%20can%20I%20place%20an%20order%3F`" target="_blank" class="w-full bg-primary text-primary-content text-center py-5 font-button italic hover:bg-secondary hover:text-secondary-content hover:scale-105 transition-all duration-300 flex items-center justify-center gap-3 shadow-lg">
