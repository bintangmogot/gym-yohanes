    ...
    >
      ...
      <div class="relative z-10 shrink-0 w-full lg:w-auto">
        <a 
          ...
          target="_blank"
          class="relative w-full sm:w-auto inline-flex items-center justify-center bg-white text-primary px-8 py-4 font-button italic shadow-xl hover:bg-secondary hover:text-secondary-content hover:scale-105 transition-all duration-300 group/btn overflow-hidden"
        >
          <div class="absolute inset-0 bg-primary/5 translate-y-full group-hover/btn:translate-y-0 transition-transform duration-300 group-hover/btn:bg-secondary"></div>
